...
# --- LanAI 1.0 Beta 2 主系統 ---
class LanAI:
    def __init__(self, model_path="lanai_v1_memory.npz"): 
        self.model_path = model_path
        self.context_h = None 
        
        # [Beta 2 更新]：訓練資料全面加上標點符號，讓 AI 學習標點的語境！
        self.base_training_data = [
            ...
            (["what", "is", "your", "name", "?"], ["my", "name", "is", "lanai", ",", "version", "1.0", "beta", "2", "."]),
        ...
        if not self.load_model():
            print("[系統] 正在初始化 1.0 Beta 2 核心 (Seq2Seq Transformer-Lite Architecture)...")
    ...
    def chat(self):
        print("="*65)
        print("  LanAI 1.0 Beta 2 (Symbol & Punctuation Aware Engine)")
        print("="*65)
        ...
        while True:
            try:
                ...
                # [Beta 2 更新]：分詞器升級，將標點符號與文字用空白隔開，保留標點符號為獨立 Token！
