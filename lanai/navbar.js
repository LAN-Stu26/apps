...
<nav id="custom-navbar">
    <a href="/lanai/home.html" class="logo">LAN Ai Studio</a>
    <ul id="nav-list">
        <li><a href="/lanai/home.html"><b>首頁</b></a></li>
        <li class="dropdown">
...
<div id="announcement-bar">
    <div class="bar-content">📢 超強的 Python 模型推出啦!</div>
...
<footer id="custom-footer">
    ...
    <div style="text-align:center; color: #aaa; border-top:1px solid #222; padding-top:20px; margin-top:20px;">
        ...
        <a href="/home.html" style="color: #aaa; text-decoration:none; margin: 0 10px;">返回本站</a>
    </div>
