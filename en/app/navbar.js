...
<nav id="custom-navbar">
    <a href="/en/home.html" class="logo">LAN Studio</a>
    <ul id="nav-list">
        <li><a href="/en/home.html"><b>Home</b></a></li>
        <li class="dropdown">
            <span class="dropbtn"><b>Web Apps ▾</b></span>
            <div class="dropdown-content">
                <a href="/en/apps.html"><b>All Web Apps</b></a>
                <a href="/en/lan.appstore.html"><b>Web App Store</b></a>
                <a href="#"  class="ai-notice-navbar">Latest ▾▾▾</a>
                <a href="/en/app/qreditor.html"><b>QRCode Toolset</b></a>
                <a href="/en/tool/time.ing.html"><b>Timer</b></a>
                <a href="/en/app/grade_calculator.html"><b>Semester Grade Calculator</b></a>
            </div>
        </li>
        <li><a href="/news.html"><b>Latest News(zh-TW)</b></a></li>
        <li class="dropdown">
            <span class="dropbtn"><b>Member Exclusive/Upgrade Programs ▾</b></span>
            <div class="dropdown-content">
                <a href="#"  class="ai-notice-navbar">Member Exclusive ▾▾▾</a>
                <a href="/en/app/note.html"><b>Encrypted Cloud Notes</b></a>
                <a href="#"  class="ai-notice-navbar">Experience Upgrade!!! ▾▾▾</a>
                <a href="/en/app/editor.html"><b>Html Editor</b></a>
            </div>
        </li>
        <li class="dropdown">
            <span class="dropbtn"><b>About Us ▾</b></span>
            <div class="dropdown-content">
                ...
                <a href="/update.news.html"><b>Update Log</b></a>
                <a href="/form/help_us.html"><b>help us</b></a>
                <a href="/form/improve-website.html"><b>Improve Form</b></a>
            </div>
        </li>
        <li id="auth-area" class="dropdown">
            <a id="login-btn">Loading...</a>
        </li>
        <li>
            <button class="fav-nav-btn" id="fav-btn" title="Bookmark this page">❤</button>
        </li>
        <li>
            <button class="search-nav-btn" id="search-nav-btn" title="Search website"></button>
        </li>
        <li class="dropdown">
...
<div id="announcement-bar">
    <div class="bar-content">📢 Help us now!<br><span style='color: #7e7e7e'>Do you speak another language? Help LAN Studio go international!</span></div>
    <div class="bar-actions">
        <a href="/form/help_us.html" class="btn-bar-go">Fill out form!</a>
...
const breadcrumbContent = isHomePage ? `home` : `<a href="/en/home.html" style="color:inherit; text-decoration:none; opacity:0.7;">home </a> > <a href="/en/apps.html" style="color:inherit; text-decoration:none; opacity:0.7;"> apps </a> > ${pageTitle}`;

const footerHTML = `
<footer id="custom-footer">
    <div class="footer-top">
        <div class="breadcrumb-box">
            <h4 style="margin:0; font-size:0.85rem; color: #aaa;">Your current location...</h4>
            <p style="margin:5px 0 0 0; font-size:1.1rem; font-weight:bold;">${breadcrumbContent}</p>
        </div>
        <div class="ai-notice">Studio JS v3.0 <br> All pages are AI-generated</div>
    </div>
    <div style="text-align:center; color: #aaa; border-top:1px solid #222; padding-top:20px; margin-top:20px;">
        <a href="#" style="color: #aaa; text-decoration:none; margin: 0 10px;"><b>Back to Top</b></a> |
        <a href="/form/improve-website.html" style="color: #aaa; text-decoration:none; margin: 0 10px;">Improve Website</a> |
        <a href="/update.news.html" style="color: #aaa; text-decoration:none; margin: 0 10px;">Update News(zh-TW)</a>
    </div>
...
if (searchNavBtn) {
    searchNavBtn.addEventListener('click', () => {
        window.location.href = '/en/search.html';
    });
}
